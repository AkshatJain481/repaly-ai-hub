        ...
        <div className="glass p-8 md:p-12 rounded-xl max-w-5xl mx-auto mb-16 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Ready to <span className="text-gradient">Automate</span> Your
              Social Media Engagement?
            </h2>
            <p className="text-lg text-foreground/80 mb-8 max-w-2xl mx-auto">
              Join 500+ creators who are saving time and boosting engagement.
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-foreground/70 mb-6 max-w-md">
              AI-powered social media automation to help creators save time and
              boost engagement.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Features", "Pricing", "Roadmap", "Integrations", "FAQ"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
