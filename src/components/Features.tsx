...
const features = [
  {
    ...
    description: "Our intelligent system monitors your Instagram comments and replies to your followers with personalized responses.",
    icon: <Zap className="h-6 w-6 text-violet-500" />,
  },
  {
    title: "Smart AI Replies",
    description: "Leverage AI to craft responses that sound just like you. Maintain your brand voice while saving hours of time.",
    icon: <MessageCircle className="h-6 w-6 text-teal-500" />,
  },
  {
    title: "Tag-Based Responses",
    description: "Create custom response templates for different types of comments with intelligent tagging system.",
    icon: <Users className="h-6 w-6 text-coral-500" />,
  },
  {
    title: "Instagram Integration",
    description: "Seamlessly connect your Instagram business account with secure authentication and easy setup.",
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Your AI-Powered Social Media <span className="text-gradient">Automation Suite</span>
          </h2>
          <p className="text-lg text-foreground/80">
            Repaly.ai helps you engage with your audience at scale without spending hours responding to comments.
          </p>
        </div>
        ...
        <div className="mt-20 glass p-6 md:p-8 rounded-xl max-w-5xl mx-auto overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold mb-4">AI That Understands Your Brand Voice</h3>
              <p className="text-foreground/70 mb-6">
                Our AI doesn't just reply - it learns your unique communication style. The more you use Repaly.ai, the better it gets at sounding exactly like you.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/5] bg-gradient-to-br from-violet-800/40 to-teal-600/40 rounded-lg overflow-hidden flex items-center justify-center">
                <div className="text-center">
                  <p className="text-sm text-foreground/50">AI Response Visualization</p>
                </div>
              </div>
              {/* Floating Elements */}
