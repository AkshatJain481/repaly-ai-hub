      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6 animate-fade-up">
            <span className="text-gradient">AI-Powered</span> Social Media Automation for Creators
          </h1>
          
          <p className="text-xl text-foreground/80 mb-10 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            Stop wasting time on Instagram replies. Let AI handle your engagement while you focus on creating amazing content.
          </p>
        ...
        {/* Hero Image */}
        <div className="mt-16 max-w-4xl mx-auto relative animate-fade-up" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="absolute -bottom-6 -left-4 glass p-4 rounded-lg shadow-lg hidden sm:block animate-float" style={{ animationDelay: "0.5s" }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-violet-400">+43% increase</p>
              </div>
            </div>
          </div>
        </div>
