              ...
              {steps.map((step, index) => (
                ...
                >
                  <div className="flex flex-row md:flex-col items-center justify-center gap-4 md:gap-2">
                    <div
                      className={`w-14 h-14 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white shadow-lg`}
                    >
                      {step.icon}
                    </div>
                  </div>
                    ...
                    {index === 1 && (
                      <div className="grid grid-cols-2 gap-3 mt-4">
                        {[
                          ...
                          <div
                            key={i}
                            className="p-2 rounded-lg bg-background/50 text-sm text-center"
                          >
                            {item}
                          </div>
                        ))}
