      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-foreground/80">
            We're starting with Instagram, but our vision extends to all major
            social platforms.
          </p>
        </div>
          ...
          {platforms.map((platform) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`text-xs font-medium rounded-full px-3 py-1 inline-flex items-center gap-1 ${
                    isAvailable
        ...
        <div className="mt-16 max-w-3xl mx-auto text-center">
          <p className="text-foreground/70">
            ...
            <button className="text-violet-400 underline">Let us know</button>{" "}
            which integrations you'd like to see next.
          </p>
        </div>
      </div>
    </section>
